...
- Configure Second Instance in N.Virginia but an another AZ
...
```bash
sudo hostnamectl set-hostname babakFirst
```
...
```bash
sudo hostnamectl set-hostname babakSecond
```
- type "bash" to see new hostname.
...
# sudo mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport fs-05119e8803ed40ab6.efs.us-east-1.amazonaws.com:/ efs
```
- Check the "efs" folder
```bash
ls
...
fs-xxxxxx:/ /home/ec2-user/efs efs _netdev,tls 0 0

# fs-xxxxxx:/ /home/ec2-user/efs efs _netdev,noresvport,tls,iam 0 0

# fs-0d9c4301e5a4c7241:/ /home/ec2-user/efs efs tls,_netdev,noresvport,tls,iam 0 0
...
```bash
sudo hostnamectl set-hostname babakThird
```
