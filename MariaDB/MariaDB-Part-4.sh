...
# Connect the babakdb on MariaDB Server on the other EC2 instance (pw:babak1234).
mysql -h ec2-3-94-163-77.compute-1.amazonaws.com -u babakuser -p

# Show that babakuser can do same db operations on MariaDB Server instance.
SHOW DATABASES;
USE babakdb;
SHOW TABLES;
