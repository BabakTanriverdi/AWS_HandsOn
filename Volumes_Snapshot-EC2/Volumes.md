...
- Create a new volume in the same AZ "us-east-1" with the instance from AWS console "2 GB" for this demo.(Attention!!!!!! the instance and volumes will be in the same AZ)
- Attach the new volume from aws console Action >>>> Attach Volume

- Select instance we created before
- Choose  "/dev/ "  as volume name but don't forget it will be seen in instance as "/dev/nvme1n1"
